...
static PyObject *ssl_Context( PyObject * spam, PyObject * args )
{
	int method;
...
static PyObject *ssl_Connection( PyObject * spam, PyObject * args )
{
	ssl_ContextObj *ctx;
	PyObject *sock;
...
static PyObject *ssl_Session( PyObject * spam, PyObject * args )
{
...
static PyObject *ssl_set_thread_safe( PyObject * spam, PyObject * args )
{
...
//  PyEval_ReleaseLock();
	...
	if ( ( module =
		   Py_InitModule3( "SSL", ssl_methods, ssl_doc ) ) == NULL )
		return;
...
#undef ADD_EXCEPTION
   ...
   PyModule_AddIntConstant( module, "SSLv2_CLIENT_METHOD",  ssl_SSLv2_CLIENT_METHOD );
   PyModule_AddIntConstant( module, "SSLv2_SERVER_METHOD",  ssl_SSLv2_SERVER_METHOD );
	PyModule_AddIntConstant( module, "SSLv3_METHOD",         ssl_SSLv3_METHOD );
   PyModule_AddIntConstant( module, "SSLv3_CLIENT_METHOD",  ssl_SSLv3_CLIENT_METHOD );
   PyModule_AddIntConstant( module, "SSLv3_SERVER_METHOD",  ssl_SSLv3_SERVER_METHOD );
	PyModule_AddIntConstant( module, "SSLv23_METHOD",        ssl_SSLv23_METHOD );
   PyModule_AddIntConstant( module, "SSLv23_CLIENT_METHOD", ssl_SSLv23_CLIENT_METHOD );
   PyModule_AddIntConstant( module, "SSLv23_SERVER_METHOD", ssl_SSLv23_SERVER_METHOD );
...
//    PyModule_AddIntConstant(module, "OP_CIPHER_SERVER_PREFERENCE", SSL_OP_CIPHER_SERVER_PREFERENCE);
	...
	/* Session constants */
	PyModule_AddIntConstant( module, "SSL_SESS_CACHE_OFF", SSL_SESS_CACHE_OFF );
	PyModule_AddIntConstant( module, "SSL_SESS_CACHE_CLIENT", SSL_SESS_CACHE_CLIENT );
	PyModule_AddIntConstant( module, "SSL_SESS_CACHE_SERVER", SSL_SESS_CACHE_SERVER );
	PyModule_AddIntConstant( module, "SSL_SESS_CACHE_BOTH", SSL_SESS_CACHE_BOTH );
	PyModule_AddIntConstant( module, "SSL_SESS_CACHE_NO_AUTO_CLEAR", SSL_SESS_CACHE_NO_AUTO_CLEAR );
	PyModule_AddIntConstant( module, "SSL_SESS_CACHE_NO_INTERNAL_LOOKUP", SSL_SESS_CACHE_NO_INTERNAL_LOOKUP );
	PyModule_AddIntConstant( module, "SSL_SESS_CACHE_NO_INTERNAL_STORE", SSL_SESS_CACHE_NO_INTERNAL_STORE );
	PyModule_AddIntConstant( module, "SSL_SESS_CACHE_NO_INTERNAL_STORE", SSL_SESS_CACHE_NO_INTERNAL_STORE );
